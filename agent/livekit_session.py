...
LIVEKIT_INSTRUCTIONS = os.environ.get("LIVEKIT_INSTRUCTIONS", (
    ...
    "1. Home Assistant MCP tools — for smart home control:\n"
    "   - Use HassTurnOn/HassTurnOff with 'name' and 'area' params for lights, switches, fans.\n"
    "   - Do NOT pass 'light' as device_class. device_class is only for covers.\n\n"
