...
import com.test.wakeword.util.FixedRingBuffer
import com.test.wakeword.util.ShortRingBuffer
...
class WakeWordManager(private val context: Context) : CoroutineScope {
    ...
    fun initialize(modelAsset: String) {
        ...
        model = PredictionModel(
            ...
            context.assets.open("melspectrogram.onnx").readBytes(),
            context.assets.open("embedding_model.onnx").readBytes(),
        )
